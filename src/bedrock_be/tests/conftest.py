...
from bedrock_be.services.redis.dependency import get_redis_pool
from bedrock_be.settings import settings
from bedrock_be.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from bedrock_be.db.models import load_all_models
